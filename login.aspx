<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Laplok_Developed.login" %>
...
<section class="position-relative h-100 pt-5 pb-4">
    ...
    <div class="container d-flex flex-wrap justify-content-center justify-content-xl-start h-100 pt-5">
      <div class="w-100 align-self-end pt-1 pt-md-4 pb-4" style="max-width: 526px;">
        ...
        <p class="text-center text-xl-start pb-3 mb-3">Don’t have an account yet? <a href="/signup">Register here.</a></p>
